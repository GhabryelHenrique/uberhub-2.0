...
export class LandingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  stats: StatItem[] = [
    { value: 619, suffix: '+', label: 'Empresas de Tecnologia', icon: 'business', current: 0, animated: false },
    { value: 250, suffix: '+', label: 'Startups mapeadas', icon: 'rocket_launch', current: 0, animated: false },
    { value: 70000, suffix: '+', label: 'Talentos no ensino superior', icon: 'school', current: 0, animated: false },
    { value: 4, suffix: 'B+', label: 'Em exits e aportes (R$)', icon: 'trending_up', current: 0, animated: false },
  ];
  ...
  personas = [
    {
      ...
      title: 'Startups',
      color: '#8540f5',
      items: ['Mentorias', 'Networking', 'Inovação aberta', 'Programas de aceleração', 'Conexão com o ecossistema'],
    },
    {
      icon: 'attach_money',
      title: 'Investidores',
      color: '#10b981',
      items: ['Demodays', 'Conexão com startups', 'Visibilidade no ecossistema', 'Conexão com investidores', 'Conexão com o ecossistema'],
    },
    {
      icon: 'corporate_fare',
      title: 'Corporates',
      color: '#3b82f6',
      items: ['Conexão com startups', 'Apoio em inovação aberta', 'Atração de talentos', 'Visibilidade no ecossistema', 'Acesso à soluções inovadoras'],
    },
    {
      icon: 'groups',
      title: 'Talentos',
      color: '#f59e0b',
      items: ['Networking', 'Acesso a todas as Vagas', 'Eventos do ecossistema', 'Cursos e capacitações', 'E muito mais…'],
    },
  ];
  ...
  cityStats = [
    { icon: '🏆', text: '1º do Brasil — ranking cidades com serviços inteligentes' },
    { icon: '🌿', text: '1º de Minas Gerais em saneamento básico e 3º do Brasil' },
    { icon: '🌾', text: '1º de MG, 4º do interior e 7º do Brasil em startups do agro' },
    { icon: '🏡', text: '1º de MG "melhores cidades para se morar" e 10º do Brasil' },
    ...
    { icon: '💰', text: '+R$4 bilhões em exits, aportes e aquisições de inovação' },
    { icon: '🚛', text: '"Capital nacional da logística" — maiores atacadistas do país' },
    { icon: '🎓', text: 'Polo universitário com +70 mil talentos no ensino superior' },
    { icon: '🌱', text: 'Agro forte com as principais empresas do setor na cidade' },
  ];

  memberAvatarColors = [
    '#6610f2','#8540f5','#10b981','#3b82f6','#f59e0b',
    '#ef4444','#ec4899','#14b8a6','#8b5cf6','#f97316',
    '#06b6d4','#84cc16','#a855f7','#22c55e','#fb923c',
  ];
  ...
  private setupCounterObserver(): void {
    ...
    this.el.nativeElement.querySelectorAll('[data-stat-index]').forEach((el: Element) => observer.observe(el));
    this.observers.push(observer);
  }
